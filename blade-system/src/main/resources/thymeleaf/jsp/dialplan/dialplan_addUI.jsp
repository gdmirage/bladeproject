...
<div class="page layui-anim layui-anim-upbit" style="margin: 10px 10px">
	...
	<form class="layui-form">
			...
			<div class="layui-form-item">
			    ...
			    <div class="layui-input-block" style="width: 30%">
					<input type="text" id="destCallNum" name="destCallNum" required  lay-verify="required" placeholder="请输入呼入号码" autocomplete="off" class="layui-input">
			    </div>
			</div>
			<div class="layui-form-item">
		...
		<div class="layui-form-item">
		    <div class="layui-input-block">
		      <button class="layui-btn" lay-submit lay-filter="dialplanForm">立即提交</button>
...
<script type="text/javascript">
	...
	form.on('submit(dialplanForm)', function(data){
		$(".layui-btn").attr('disabled',true);  //防止重复提交 
		var url = " ${baseURL}/dialplan/add";
