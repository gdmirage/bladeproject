...
<link href="${baseURL }/common/css/xzg.common.css" rel="stylesheet" type="text/css" media="screen"/>
<link href="${baseURL }/common/css/xzg.pages.css" rel="stylesheet" type="text/css" media="screen"/>
...
<script src="${baseURL }/dwz/xheditor/xheditor_lang/zh-cn.js" type="text/javascript"></script>
<script src="${baseURL }/dwz/uploadify/scripts/jquery.uploadify.min.js" type="text/javascript"></script>

<link href="${baseURL }/common/js/jquery-clockpicker/jquery-clockpicker.min.css" rel="stylesheet" type="text/css" media="screen"/>
<script src="${baseURL }/common/js/jquery-clockpicker/jquery-clockpicker.min.js" type="text/javascript"></script>
...
<script src="${baseURL }/common/js/qrcode/jquery.qrcode.min.js" type="text/javascript"></script>
