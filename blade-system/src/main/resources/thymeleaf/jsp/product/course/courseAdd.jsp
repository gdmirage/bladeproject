...
<div class="page" style="margin: 10px 10px">
    <form class="layui-form" method="post" id="productForm">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea name="courseSubtitle" required lay-verify="required" placeholder="请输入课程描述" class="layui-textarea"></textarea>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
        	<div class="layui-inline">
			    ...
			    <div class="layui-input-block">
					<input type="checkbox" checked="" value="YES" name="isSell" lay-skin="switch" lay-filter="switchIsSell" lay-text="是|否">
			    </div>
		    </div>
        	<div class="layui-inline">
	        	<label class="layui-form-label">现场课程：</label>
			    <div class="layui-input-block">
					<input type="checkbox" value="YES" name="isHomeShow" lay-skin="switch" lay-filter="switchIsHomeShow" lay-text="是|否">
			    </div>
		    </div>
		    <div class="layui-inline">
			    <label class="layui-form-label">专业课程：</label>
			    <div class="layui-input-block">
					<input type="checkbox" value="YES" name="isMajor" lay-skin="switch" lay-filter="switchIsMajor" lay-text="是|否">
			    </div>
		    </div>
        ...
        <div class="layui-form-item">
        	<div class="layui-inline">
			    ...
			    <div class="layui-input-block">
					<input type="checkbox" value="YES" name="isConfirmReceipt" lay-skin="switch" lay-filter="switchIsConfirmReceipt" lay-text="是|否">
			    </div>
		    </div>
		    <div class="layui-inline">
			    <label class="layui-form-label">收货地址：</label>
			    <div class="layui-input-block">
					<input type="checkbox" value="YES" name="isOpenAddress" lay-skin="switch" lay-filter="switchIsOpenAddress" lay-text="是|否">
			    </div>
		    </div>
        	<div class="layui-inline">
	        	<label class="layui-form-label">站内课程：</label>
			    <div class="layui-input-block">
					<input type="checkbox" value="YES" name="isSelfSite" lay-skin="switch" lay-filter="switchIsSelfSite" lay-text="是|否">
			    </div>
		    </div>
		    <div class="layui-inline">
        ...
        <div class="layui-form-item isSell">
        	<div class="layui-inline">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="courseUrl" lay-verify="required" placeholder="请输入课程的链接地址" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <script id="courseEditor" type="text/plain" style="width:480px;height: 200px"></script>
            </div>
        </div>
