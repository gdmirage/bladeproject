...
<div class="page layui-anim layui-anim-upbit" style="margin: 10px 10px">
	...
	<table class="layui-hide" id="courseCouponTable" lay-filter="courseCouponTable"></table>
...
<script type="text/javascript">
	...
	upload.render({
	    elem: '#selectFile'
	    ,url: '${baseURL}/course/uploadCoupon'
	    ,auto: false
	    ,data: {
	    	id : courseOrColumnId
	    }
	...
	var tableInit = table.render({
        elem: '#courseCouponTable'
        , url: '${baseURL}/course/otherCouponlist/'
        , request: {
