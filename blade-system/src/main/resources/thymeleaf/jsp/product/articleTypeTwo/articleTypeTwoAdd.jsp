...
<div class="page layui-anim layui-anim-upbit" style="margin: 10px 10px">
	...
	<form class="layui-form">
		...
		<div class="layui-form-item">
            ...
            <div class="layui-upload">
                ...
                <div class="layui-upload-list">
                    ...
                    <p id="demoText"></p>
                    <input type="hidden" name="typeImg" id="typeImg"/>
                </div>
            </div>
        </div>
		...
		<div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
				<input type="text" name="twoTypeName" required  lay-verify="required" placeholder="请输入分类名称" autocomplete="off" class="layui-input">
		    </div>
		</div>
		...
		<div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
				<input type="number" name="typeIndex" required  lay-verify="required" placeholder="请设置分类的排序号" autocomplete="off" class="layui-input">
		    </div>
		</div>
		...
		<div class="layui-form-item">
        	<div class="layui-inline">
			    ...
			    <div class="layui-input-block">
					<input type="checkbox" checked="" value="YES" name="isShow" lay-skin="switch" lay-filter="switchIsShow" lay-text="是|否">
			    </div>
		    </div>
		</div>
		...
		<div class="layui-form-item">
		    <div class="layui-input-block">
		      <button class="layui-btn" lay-submit lay-filter="articleTypeTwoAddForm">立即提交</button>
...
<script type="text/javascript">
	...
	form.on('submit(articleTypeTwoAddForm)', function(data){
       var url = "${baseURL}/articleTypeTwo/add";
