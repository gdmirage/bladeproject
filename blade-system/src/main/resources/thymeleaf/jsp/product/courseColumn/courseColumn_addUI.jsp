    ...
    <form class="layui-form" method="post" id="productForm">
        ...
        <div class="layui-form-item">
        	<div class="layui-inline">
			    ...
			    <div class="layui-input-block">
					<input type="checkbox" value="YES" name="isUp" lay-skin="switch" lay-filter="switchIsUp" lay-text="是|否">
			    </div>
		    </div>
		    <div class="layui-inline">
		    ...
		    <div class="layui-inline">
			    ...
			    <div class="layui-input-block">
					<input type="checkbox" value="YES" name="isConfirm" lay-skin="switch" lay-filter="switchIsConfirm" lay-text="是|否">
			    </div>
		    </div>
		    <div class="layui-inline">
			    <label class="layui-form-label">推送课程：</label>
			    <div class="layui-input-block">
					<input type="checkbox" value="YES" name="isSend" lay-skin="switch" lay-filter="switchIsSend" lay-text="是|否">
			    </div>
		    </div>
		</div>
		...
		<div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <script id="columnDesEditor" type="text/plain" style="width:480px;height: 200px"></script>
            </div>
        </div>

        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn" lay-submit lay-filter="courseColumnForm">立即提交</button>
...
<script type="text/javascript">
    ...
    form.on('submit(courseColumnForm)', function (data) {
        var url = "${baseURL}/courseColumn/add";
        //获取富文本信息
