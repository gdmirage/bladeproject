	...
	<form class="layui-form">
		<div class="layui-form-item">
			...
			<div class="layui-input-block" style="width: 30%" layui-form>
				<select id="userId" name="userId" required lay-verify="required"
					lay-search>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block" style="width: 30%" layui-form>
				<select id="groupId" name="groupId" required lay-verify="required"
					lay-search>
					<option value="">请选择</option>
		...
		<div class="layui-form-item">
			<div class="layui-input-block">
				<button class="layui-btn" lay-submit
					lay-filter="userGroupMappingForm">立即提交</button>
...
<script type="text/javascript">
	...
	form.on('submit(userGroupMappingForm)', function(data) {
		$(".layui-btn").attr('disabled',true);  //防止重复提交 
		var url = " ${baseURL}/seatGroupMapping/add";
