...
<div class="page" style="margin: 10px 10px">
    ...
    <form class="layui-form" method="post">
        ...
        <input type="hidden" name="number" value="${pmsMenu.number}"/>

        <div class="layui-form-item">
            <div class="layui-inline">
                <label class="layui-form-label">请求URL</label>
                <div class="layui-input-inline">
                    <input type="text" name="url" maxlength="50" value="${pmsMenu.url}" autocomplete="off"
                           class="layui-input" placeholder="请输入URL"/>
                </div>
            </div>
        </div>
