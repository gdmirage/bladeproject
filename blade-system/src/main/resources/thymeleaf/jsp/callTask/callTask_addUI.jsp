...
<div class="page layui-anim layui-anim-upbit" style="margin: 10px 10px">
	...
	<form class="layui-form">
		...
		<div class="layui-form-item">
			...
			<!-- <input type="text" id="startTime" name="startTime" required  lay-verify="required" placeholder="请输入startTime" autocomplete="off" class="layui-input"> -->
		</div>
		<div class="layui-form-item">
		...
		<div class="layui-form-item">
			<div class="layui-input-block">
				<button class="layui-btn" lay-submit lay-filter="callTaskForm">立即提交</button>
...
<script type="text/javascript">
	...
	form.on('submit(callTaskForm)', function(data) {
		$(".layui-btn").attr('disabled',true);  //防止重复提交 
		var url = " ${baseURL}/callTask/add";
