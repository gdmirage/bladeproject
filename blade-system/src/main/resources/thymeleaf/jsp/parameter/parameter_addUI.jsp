    ...
    <form class="layui-form" method="post" id="productForm">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="paramCode" required lay-verify="required" placeholder="请输入参数编码"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="paramName" lay-verify="required" placeholder="请输入参数名称" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
